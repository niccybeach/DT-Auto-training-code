...
replace_value(236, new_array[0][0][0])   #cor
replace_value(258, new_array[0][1][0])  #cof
replace_value(259, new_array[0][2][0])  #corf
replace_value(242, new_array[0][3][0]) #d_t_n
replace_value(256, new_array[0][4][0]) #s_t_n
replace_value(254, new_array[0][5][0]) #kn
