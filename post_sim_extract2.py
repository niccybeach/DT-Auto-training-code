...
new_data.to_csv('output1.csv', mode='a', header=False, index=False)
new_data1.to_csv('output1.csv', mode='a', header=False, index=False)
new_data2.to_csv('output1.csv', mode='a', header=False, index=False)
new_data4.to_csv('output1.csv', mode='a', header=False, index=False)
new_data3.to_csv('output1.csv', mode='a', header=False, index=False)
